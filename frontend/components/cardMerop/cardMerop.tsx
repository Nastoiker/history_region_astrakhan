...
export const CardMerop = ({date, name, description, img}): JSX.Element => {
    return <div className={"mx-auto m-10 flex max-w-screen-lg justify-between border p-5 rounded-3xl bg-zinc-900 items-center hover:scale-110 transition-all hover:bg-zinc-800 hover:border-none "}>
