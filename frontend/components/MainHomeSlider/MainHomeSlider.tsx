    ...
    <div className={"relative my-0"} >
      ...
      <div className={'mx-auto text-center'}>
            <div className={"flex justify-center items-center"}>
                    <Image className={"object-cover    left-48     w-10 z-10 " + styles.Logo} alt='slider' src={GerbCenter}/>
          <h1 className={"mx-auto ml-auto text-3xl word-breaks font-bolds"}>АСТРАХАНСКИЙ</h1>
        </div>
